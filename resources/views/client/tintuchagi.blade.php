...
<div class="container">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb hyundai-headFont">
            ...
            <li class="breadcrumb-item active" aria-current="page">Tin công ty</li>
        </ol>
    </nav>
    <div id="tinTucKhac" class="container hyundai-normalfont">
        <h3 class="hyundai-headFont text-left">TIN TỨC HYUNDAI AN GIANG</h3><br/>
        <div class="row text-justify">
            <div class="col-xs" id="tinTucKhacPanel"> 
                ...
                <div class="d-flex justify-content-center">
                    {{$tinHAGI->links('pagination::bootstrap-4')}}
                </div>
            </div>
